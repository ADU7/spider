...
# browser = webdriver.Chrome(executable_path="/Users/peihuidu/PycharmProjects/chromedriver")
...
# import time
# time.sleep(5)
# browser.find_element_by_css_selector("#loginname").send_keys("939744734@sina.com")
...
browser = webdriver.PhantomJS(executable_path="/Library/phantomjs-2.1.1-macosx/bin/phantomjs")
